  ...
  return (
    <main className="flex flex-col-reverse md:flex-row min-h-screen relative">
      ...
      <section className="flex flex-1 min-h-screen flex-col justify-center gap-3 px-8 ">
        ...
        <q className="text-2xl mt-6 fade font-semibold text-pink-600 w-full md:max-w-96 border-l-8 uppercase px-4">Experience Greateness with us at YOMCOIN. We are coming loaded!</q>
